...
CREATE FUNCTION STAFF_IN_DEP (DEPNAME VARCHAR(120))
 ...
 CREATE FUNCTION ADD_EMPLOYEE(THE_EGN varchar(10), THE_PHONE VARCHAR(13) , THE_DEP VARCHAR(120), THE_DB DATE, THE_SALARY DOUBLE, THE_MANAGER VARCHAR(10))
 	LANGUAGE SQL
 	F1: BEGIN ATOMIC
	 	...
	 	END IF;
	 	INSERT INTO staff(egn, phone, department, bd, salary, linear_manager) VALUES (THE_EGN, THE_PHONE, THE_DEP, THE_SALARY, THE_MANAGER);
	 RETURN NULL;
 	END;
